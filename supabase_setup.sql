-- OPD Platform Database Schema for Supabase Migration
...
-- 3. Sessions table (Consultations)
...
-- 4. Transcripts table (Chat/Audio logs)
...
-- 5. Prescriptions table (Clinical Notes)
