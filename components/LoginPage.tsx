            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-lg shadow-md p-8">
                    <h2 className="text-2xl font-semibold text-slate-900 mb-6">
                        {isGuestMode ? 'Guest Access' : 'Welcome Back'}
                    </h2>
                    ...
                    {!isGuestMode ? (
                        <>
                            ...
                            <div className="mt-4">
                                ...
                                <button
                                    ...
                                    className="mt-4 w-full flex items-center justify-center gap-2 bg-white text-slate-700 border border-slate-300 hover:bg-slate-50 font-medium py-2 px-4 rounded-md transition-colors"
                                >
                                ...
                                <button
                                    ...
                                    className="mt-3 w-full flex items-center justify-center gap-2 bg-slate-100 text-slate-700 hover:bg-slate-200 font-medium py-2 px-4 rounded-md transition-colors"
                                >
                                    Continue as Guest
                                </button>
                            </div>
                        ...
                        <form onSubmit={handleGuestSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full text-slate-600 hover:text-slate-800 font-medium py-2 px-4 rounded-md transition-colors"
                            >
                                Back to Login
                            </button>
                        </form>
